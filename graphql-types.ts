...
export type Unnamed_1_Query = { allFile: { nodes: Array<{ id: string, name: string, publicURL?: string | null }> } };

export type Unnamed_2_QueryVariables = Exact<{ [key: string]: never; }>;


export type Unnamed_2_Query = { markdownRemark?: { html?: string | null } | null };
